<template>
  <div class="page-picker">
    ...
    <div class="page-picker-wrapper">
      <f-picker :slots="yearSlot" @change="onYearChange" :visible-item-count="3"></f-picker>
    </div>
    <p class="page-picker-desc">出生年份: {{ year }}</p>

    <div class="page-picker-wrapper">
      <f-picker :slots="dateSlots" @change="onDateChange" :visible-item-count="3"></f-picker>
    </div>
    <p class="page-picker-desc">在校时间: {{ dateStart }} 至 {{ dateEnd }}</p>

    <div class="page-picker-wrapper">
      <f-picker :slots="addressSlots" @change="onAddressChange" :visible-item-count="5"></f-picker>
    </div>
    <p class="page-picker-desc">地址: {{ addressProvince }} {{ addressCity }}</p>
    
    <!-- defaultIndex 参数变化 -->
    <div class="page-picker-wrapper">
      <f-picker :slots="numberSlot" @change="onNumberChange" :visible-item-count="3"></f-picker>
    </div>
