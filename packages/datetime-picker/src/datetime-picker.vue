...
<script type="text/babel">
  import picker from 'f-ui/packages/picker/index.js';
  import popup from 'f-ui/packages/popup/index.js';
  if (process.env.NODE_ENV === 'component') {
    require('f-ui/packages/picker/style.css');
    require('f-ui/packages/popup/style.css');
  }
