# Overview
f-popup is a popup component for vue.js

# Installation
First, install `f-popup` from npm:
```bash
$ npm install f-popup
```
...
Import it:
```Javascript
require ('f-popup/lib/index.css');

// ES6 mudule
import Popup from 'f-popup';

// CommonJS
const Popup = require('f-popup').default;
```
